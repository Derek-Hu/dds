...
export const LiquidatorABI = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contract DDSRewardsInterface',
        name: '',
        type: 'address',
      },
    ],
...
export const BN_TRADE_ABI_NEW = [
  ...
  },
  {
    ...
    outputs: [
      {
        internalType: 'contract IFormular',
        name: '',
        type: 'address',
      },
    ],
  ...
  },
  {
    ...
    name: 'setDDSbrokerAndLiquidorAddr',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
export const BN_Liquidator_ABI = [
  ...
  },
  {
    ...
    name: 'getFeeBackByLiquidorAndPeriod',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
  ...
  {
    inputs: [],
    name: 'getStartTimeAndCurrentPeriod',
    outputs: [
      {
        internalType: 'uint256',
        name: 'time',
...
export const BN_Rewards_ABI = [
  ...
  },
  {
    ...
    name: 'claimRewardsForLP1EveryTokenType',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
  ...
  {
    inputs: [],
    name: 'ddsRewardsDenominatorForLP2',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
  ...
  {
    inputs: [],
    name: 'ddsRewardsNumeratorForLP2',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
  ...
  },
  {
    ...
    name: 'disableContractAddressesForLP2',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'enableContractAddressesForLP2',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    name: 'getLockedRewardsInfoForLP1',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
  ...
  },
  {
    ...
    name: 'getLockedRewardsInfoForLP1EveryTokenType',
    outputs: [
      {
        internalType: 'uint256',
        name: '',
    ...
    outputs: [
      {
        ...
        internalType: 'struct DDSRewards.LP1Info',
        name: '',
        type: 'tuple',
      },
    ],
  ...
  },
  {
    ...
    name: 'setContractAddressesForLiquidor',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [
      {
        internalType: 'uint256',
        name: '_ddsRewardsNumeratorForLP2',
        type: 'uint256',
      },
      {
        internalType: 'uint256',
        name: '_ddsRewardsDenominatorForLP2',
        type: 'uint256',
      },
    ],
    name: 'setDDSRewardsParamatersForLP2',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  {
    inputs: [
      {
        internalType: 'uint256',
        name: '_ddsPriceForRewardsNumerator',
        type: 'uint256',
      },
    ],
    name: 'setParmsAfterHalving',
  ...
  },
  {
    inputs: [
      {
        internalType: 'uint256',
        name: '_rewardsPerBlockForLP1',
        type: 'uint256',
      },
    ],
    name: 'setRewardsPerBlockForLP1',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
...
export const BN_ABI: { [p in keyof ContractAddress]: any[] } = {
  ...
  TradeUSDCContract: BN_TRADE_ABI,
  Lp1DAIContract: Pl1ABI,
  Lp1USDTContract: Pl1ABI,
  Lp1USDCContract: Pl1ABI,
  Lp2DAIContract: Pl2ABI,
  Lp2USDTContract: Pl2ABI,
  Lp2USDCContract: Pl2ABI,
  MiningRewardContract: BN_Rewards_ABI,
