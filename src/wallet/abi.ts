...
export const BN_ABI: { [p in keyof ContractAddress]: any[] } = {
  ...
  Lp1DAIContract: BN_Pl1_ABI,
  Lp1USDTContract: BN_Pl1_ABI,
  Lp1USDCContract: BN_Pl1_ABI,
  Lp2DAIContract: BN_Pl2_ABI,
  Lp2USDTContract: BN_Pl2_ABI,
  Lp2USDCContract: BN_Pl2_ABI,
  MiningRewardContract: RewardsABI,
